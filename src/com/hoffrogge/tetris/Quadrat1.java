...
public class Quadrat1 extends AllgemeinerTetromino {
	...
	public void zeichnen(Graphics graphics) {
		...
		super.zeichneRechteck(graphics, xQuadrat + getKantenlaenge(), yQuadrat, fuellFarbe);
		super.zeichneRechteck(graphics, xQuadrat, yQuadrat + getKantenlaenge(), fuellFarbe);
		super.zeichneRechteck(graphics, xQuadrat + getKantenlaenge(), yQuadrat + getKantenlaenge(), fuellFarbe);
