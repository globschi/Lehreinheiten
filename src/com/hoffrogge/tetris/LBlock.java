...
public class LBlock extends AllgemeinerTetromino {
	...
	public void zeichnen(Graphics graphics) {
		super.zeichneRechteck(graphics, xLBlock, yLBlock, fuellFarbe);
		super.zeichneRechteck(graphics, xLBlock + getKantenlaenge(), yLBlock, fuellFarbe);
		super.zeichneRechteck(graphics, xLBlock + getKantenlaenge() + getKantenlaenge(), yLBlock, fuellFarbe);
		super.zeichneRechteck(graphics, xLBlock + getKantenlaenge() + getKantenlaenge(), yLBlock - getKantenlaenge(),
				fuellFarbe);
